...
(N'T_HNtoMC01', N'Tour starts', N'none', N'FC_HN_TN01', N'Make your way to Thung Khe Pass', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Visit Thung Khe Pass', N'TS_MC_TK01', N'none', N'Sightseeing as you climb through the pass', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Board the bus', N'none', N'FC_HN_TN01', N'Move to Ba Chị Em Restaurant', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoCB01', N'Have lunch at a local restaurant', N'none', N'FC_MC_BCE01', N'Have lunch and a short break at Ba Chị Em Restaurant', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Board the bus', N'none', N'FC_HN_TN01', N'Go to Dải Yếm Waterfall', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Visit Dải Yếm Waterfall', N'TS_HN_DY01', N'none', N'Sightseeing at Dải Yếm Waterfalls', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Have dinner and rest', N'none', N'FC_HN_TN01', N'Return to have dinner and stay the night at the 88 Hotel', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
...
(N'T_HNtoMC01', N'Have dinner and rest', N'none', N'FC_MC_EE01', N'Have dinner and stay the night at 88 Hotel', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Board the bus', N'none', N'FC_HN_TN01', N'Check out of the hotel and move to the tea hill', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Visit Trái tim Mộc Châu tea hill', N'TS_HN_TMC01', N'none', N'Sightseeing at take pictures at the Trái tim Mộc Châu tea hill', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Board the bus', N'none', N'FC_HN_TN01', N'Make way to the restaurant for lunch', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Have lunch and rest', N'none', N'FC_MC_HT01', N'Have lunch and a short break at Hợp Thủy Restaurant', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoMC01', N'Tour ends', N'none', N'FC_HN_TN01', N'The bus travels back to Hà Nội', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Tour starts', N'none', N'FC_HN_NN01', N'Board the bus and make way to the hotel', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Check in the hotel', N'none', N'FC_VY_NA01', N'Check in at Nguyệt Anh Hotel', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Have lunch and rest', N'none', N'FC_VY_NA01', N'Have lunch and a break at Nguyệt Anh Hotel', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Board the bus', N'none', N'FC_HN_NN01', N'Move to Bạc Waterfall', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
...
(N'T_HNtoTD01', N'Visit Bạc Waterfall', N'TS_HN_B01', N'none', N'Sightseeing at Bạc Waterfall', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Board the bus', N'none', N'FC_HN_NN01', N'Return to the hotel', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Have dinner and rest', N'none', N'FC_VY_NA01', N'Have dinner and stay the night at Nguyệt Anh Hotel', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Check out and board the bus', N'none', N'FC_HN_NN01', N'Check out of the hotel and move to Cát Cát Village', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Visit Cát Cát Village', N'TS_HN_CC01', N'none', N'Visit Cát Cát Village', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Board the bus', N'none', N'FC_HN_NN01', N'Go to Phố Núi Restaurant', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Have lunch and rest', N'none', N'FC_VY_PN01', N'Have lunch and a short break at the restaurant', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Board the bus', N'none', N'FC_HN_NN01', N'Make your way to Gió Tam Đảo Cafe', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Enjoy local coffe at Gió Tam Đảo Cafe', N'none', N'FC_VY_GTD01', N'Have coffe, take photos, and sightseeing at the Gió Tam Đảo Cafe', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
(N'T_HNtoTD01', N'Tour ends', N'none', N'FC_HN_NN01', N'Return to Hà Nội', CAST(N'2022-08-12T06:00:00.000' AS DateTime), CAST(N'2022-08-12T06:00:00.000' AS DateTime), NULL),
